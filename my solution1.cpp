...
class SkillWillSubject: public Abstracsubject {
    public:
        ...
        void subjectTitle(string SubjectTitle) {
            this-> SubjectTitle = SubjectTitle;
            cout << " The title of the last lecture is : " << SubjectTitle << endl;
            cout << endl;
        }
...
int main()
{
    SkillWillSubject skillWillSubject("web", 7, "16.11.2022");
    SkillWillSubject skillWillSubject1("mobile", 7, "16.11.2022");
    skillWillSubject.subjectTitle("OOP");
    ...
    SkillWillLecturer skillWillLecturer1("Aleksandre", "Kutaladze", "React-native");
    skillWillLecturer1.conduqtingLecturer(skillWillSubject1);
    skillWillLecturer1.lecturerSkill("React-native", "Senior");

    SkillWillStudent skillWillStudent("Levan", "mermanishvili", 33, "CPP");

    skillWillStudent.studentInfo();
    skillWillStudent.studentSkill('b', 7, 30000);
    skillWillStudent.updateQuiz(5000);
